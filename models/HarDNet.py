...
from models.module import ConvBNRelu, ConvBNActivation, ConvBN
...
class HarDNet(BaseModel):
    ...
    def __init__(self,
        ...
        self.stem = nn.Sequential(
            ConvBNRelu(3, stem_channels[0], kernel_size=3, bias=False),
            ConvBNRelu(stem_channels[0], stem_channels[1], kernel_size=3, bias=False),
            ConvBNRelu(stem_channels[1], stem_channels[2], kernel_size=3, stride=2, bias=False),
            ConvBNRelu(stem_channels[2], stem_channels[3], kernel_size=3, bias=False))
